<div class="flex-1 flex flex-col min-h-screen max-h-screen max-w-[350px] w-full">

    <div id="message-container" class="max-w-lg px-4 pt-4 h-full grow bg-gray-900 text-gray-100 overflow-y-auto"></div>
